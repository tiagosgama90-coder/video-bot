...
exigirTexto('./src/lib/conteudo-especial.ts', 'Ok, isso é real', 'VIP: legendas humanizadas PT');
...
exigirTexto('./src/lib/ganchos-diario.ts', 'depressão em voz alta', 'Diário: gancho depressão PT');
exigirTexto('./src/lib/ganchos-diario.ts', 'afinidade do seu parceiro', 'Diário: gancho afinidade parceiro PT');
exigirTexto('./src/lib/ganchos-virais.ts', 'afinidade do seu parceiro', 'Viral: gancho afinidade parceiro');
...
exigirTexto('./config/sidusastro.json', '"volume": "+8.00%"', 'Voz: volume natural');
...
exigirTexto('./src/lib/conteudo-especial.ts', "export const TITULO_VIP_DIVULGACAO = 'SEU PREMIUM VITALÍCIO'", 'Premium: título marketing');
...
exigirTexto('./src/lib/legendas-marketing.ts', '#astrologiabrasileira', 'Marketing: hashtags Brasil');
...
exigirTexto('./config/sidusastro.json', 'pt-BR-ThalitaNeural', 'Voz PT: feminina BR zen');
exigirTexto('./config/sidusastro.json', 'pt-BR-AntonioNeural', 'Voz PT: masculina BR zen');
exigirTexto('./src/lib/ganchos-diario.ts', 'escolherGanchoNarracao', 'Diário: gancho só para narração');
exigirTexto('./src/lib/ganchos-diario.ts', 'limparGanchoParaNarracao', 'Diário: sem legenda/comenta na voz');
exigirTexto('./src/lib/fechos-narracao.ts', 'escolherFechoVoz', 'Diário: fecho zen na narração');
exigirTexto('./config/sidusastro.json', '"femininaRate": "-10%"', 'Voz: prosódia feminina zen BR');
...
exigirFicheiro('./src/lib/legendas-rotativas.ts');
exigirTexto('./src/lib/legendas-rotativas.ts', 'obterLegendasVip', 'Legendas: VIP rotativo por data');
exigirTexto('./src/lib/legendas-rotativas.ts', 'obterLegendasAfiliados', 'Legendas: afiliados rotativo por data');
exigirTexto('./src/lib/legenda.ts', 'escolherGanchoViral', 'Diário: legenda Instagram viral');
exigirTexto('./src/lib/ganchos-diario.ts', 'escolherGanchoLegendaTikTok', 'Diário: legenda TikTok distinta');
